...
class CAtt(object):
    def __init__(self, sequence_length, target_sequence_length,targets_num_max, num_classes, word_embedding, l2_reg_lambda=0.0,
        ...
        self.input_target = tf.compat.v1.placeholder(tf.int32, [None, target_sequence_length], name="input_x")  # The target
        self.input_targets_all = tf.compat.v1.placeholder(tf.int32, [None,targets_num_max, target_sequence_length], name="input_x")  #All the targets
        ...
        with tf.compat.v1.name_scope('targets_all_len'):
        ...
        self.target_which = tf.compat.v1.placeholder(tf.float32, [None, targets_num_max ], name='which_one_target')
        self.target_position = tf.compat.v1.placeholder(tf.float32, [None, sequence_length], name='target_position')
        with tf.compat.v1.name_scope('targets_all_position'):
        ...
        with tf.compat.v1.name_scope("embedded_sen"):
        ...
        with tf.compat.v1.name_scope("embedding_target"):
        ...
        with tf.compat.v1.name_scope("Bi-LSTM_sentence"):
        ...
        with tf.compat.v1.name_scope("Bi-LSTM_target"):
            cell = tf.compat.v1.nn.rnn_cell.LSTMCell
        ...
        with tf.compat.v1.name_scope("Attention-sentence2target"):
        ...
        with tf.compat.v1.name_scope("Attention-target2sentence"):
            # position
        ...
        with tf.compat.v1.name_scope("output"):
            W = tf.compat.v1.Variable(tf.random_normal([num_hidden * 2, num_classes]))
            b = tf.compat.v1.Variable(tf.random_normal([num_classes]))
